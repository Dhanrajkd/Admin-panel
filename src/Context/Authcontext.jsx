...
export const AuthProvider = ({ children }) => {
  ...
  const login = async (email, password) => {
    try {
      let responce=await fetch("http://localhost:4000/check_admin",{
        method:'POST',
        headers:{
  ...
  const checkemail=async (email)=>{
      try {
      let responce=await fetch("http://localhost:4000/check_email",{
        method:'POST',
        headers:{
          accept:"application/json",
          "Content-Type":"application/json"
  ...
  const addnew_pass=async (email,password)=>{
      try{
          let responce=await fetch("http://localhost:4000/new_password",{
            method:"PATCH",
            headers:{
              accept:"application/json",
              "Content-Type":"application/json"
