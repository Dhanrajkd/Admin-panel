...
const Employees = () => {
  ...
  const handleSubmit = async () => {
    if (editId) {
         try{
      console.log(editId)
      const responce =await fetch(`https://admin-panel-backend-m7do.onrender.com/api/admin/edit_emp/${editId}`,{
        method:"PUT",
        headers:{
     ...
     console.log(formData)
      ...
      try{
          let responce=await fetch("https://admin-panel-backend-m7do.onrender.com/api/admin/add_employee",{
            method:"POST",
            body:data
          })
  ...
  const handleDelete = async (id) => {
      try{
      const responce=await fetch(`https://admin-panel-backend-m7do.onrender.com/api/admin/emp_delete/${id}`,{
        method:"DELETE",
        headers:{
          "Content-Type": "application/json",
        }
